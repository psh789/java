...
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // var3가 3보다 크고 그리고 var4가 3보다 크다. (거짓) &&(둘다 참일때 참)
		boolean res2 = (var3 > 2) && (var4 > 3); // var3가 2보다 크고 그리고 var4가 3보다 크다. (참)
		boolean res3 = (var3 > 3) || (var4 > 3); // var3가 3보다 크고 또는 var4가 3보다 크다. (참)
		boolean res4 = (var3 > 3) || (var4 > 5); // var3가 3보다 크고 또는 var4가 5보다 크다.(거짓)  ||(둘중하나라도 참일땐 참 or)
		boolean res5 = !(var3 > var4); // var3가 var4보다 크지 않다.(참) !(부정)
